        ...
        // finally if all the above checks are ok
            ...
            if ($this->databaseConnection()) {
                ...
                if ($query_check_user_name->fetchColumn() != false) {
                    ...
                    $query_new_user_insert = $this->db_connection->prepare('INSERT INTO users (user_name, user_password_hash, user_email, user_activation_hash, user_registration_ip) VALUES(:user_name, :user_password_hash, :user_email, :user_activation_hash, :user_registration_ip)');
