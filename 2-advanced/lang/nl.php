...
'database_error'	=> 'Er is een probleem met de database verbinding.',
...
'empty_password'	=> 'Wachtwoord vel was leeg',
...
'invalid_email'	=> 'Uw e-mailadres is in een ongeldig formaat',

// Registration class
'wrong_captcha'	=> 'Beveiligingscode is onjuist!',
'username_bad_length'	=> 'Gebruikersnaam mag niet korter zijn dan 2 of langer dan 64 karakters',
'empty_email'	=> 'E-mailadres mag niet leeg zijn',
'email_too_long'	=> 'E-mail adres mag niet langer zijn dan 64 karakters',
'verification_mail_error'	=> 'Sorry, we hebben geen activatiemail kunnen sturen. Uw account is NIET aangemaakt',
'verification_mail_sent'	=> 'Uw account is succesvol aangemaakt, we hebben u een activatiemail gestuurd. Klik op de link in deze mail om uw account te activeren.',
...
'wrong_password'	=> 'Verkeerd wachtwoord ingevoerd. Probeer opnieuw.',
'account_not_activated'	=> 'Uw account is nog niet geactieveerd. Klik op de bevestigingslink in de mail.',
'logged_out'	=> 'U bent uitgelogd.',
'same_username'	=> 'Sorry, de ingevoerde gebruikersnaam is gelijk aan uw huidige. Kies een andere.',
'same_email'	=> 'Sorry, het ingevoerde e-mailadres is gelijk aan uw huidige. Kies een andere.',
'username_changed'	=> 'Uw gebruikersnaam is succesvol gewijzigd. Nieuwe gebruikersnaam is ',
'username_change_failed'	=> 'Sorry, gebruikersnaam wijzigen mislukt',
...
'password_changed failed'	=> 'Sorry, het wijzigen van uw wachtwoord mislukt.',
'wrong_old_password'	=> 'Uw oude wachtwoord is verkeerd ingevoerd.',
...
// Edit account
'edit_title'	=> 'U bent ingelogd en u kunt uw gegevens hier wijzigen',
'old_password'	=> 'Uw OUDE wachtwoord',
'new_username'	=> 'Nieuwe gebruikersnaam (gebruikersnaam mag niet leeg zijn en mogen enkel azAZ09 en 2-64 karakters bevatten)',
