...
<script src="<?php echo PHPLOGIN_LOCATION; ?>views/js/jquery-1.9.1.min.js" type="text/javascript"></script>
<script src="<?php echo PHPLOGIN_LOCATION; ?>views/js/jquery.md5.min.js" type="text/javascript"></script>
<!--PHPLogin specific JavaScript (no logic stuff here, just css/layout actions) -->
<script src="<?php echo PHPLOGIN_LOCATION; ?>views/js/beautiful_login.js" type="text/javascript"></script>       
