...
/**
 * Class Database
 * Creates a PDO database connection. This connection will be passed to every model-class (so we use
 * the same connection for all classes / objects and prevent to open multiple connections at once)
 */
