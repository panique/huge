...
class NoteModel
{
    ...
    public function create($note_text)
    {
        ...
        if ($count == 1) {
            ...
            $_SESSION["feedback_negative"][] = Lang::__('FEEDBACK_NOTE_CREATION_FAILED');
        }
        // default return
        return false;
    }
    ...
    public function editSave($note_id, $note_text)
    {
        ...
        if ($count == 1) {
            ...
            $_SESSION["feedback_negative"][] = Lang::__('FEEDBACK_NOTE_EDITING_FAILED');
        }
        // default return
        return false;
    }
    ...
    public function delete($note_id)
    {
        ...
        if ($count == 1) {
            ...
            $_SESSION["feedback_negative"][] = Lang::__('FEEDBACK_NOTE_DELETION_FAILED');
        }
        // default return
        return false;
    }
