 ...
 *
 * A simple PHP Login Script without all the nerd bullshit. Uses PHP SESSIONS,
 * modern password-hashing and salting and gives the basic functions a proper
 * login system needs. Please remember: this is just the minimal version of
 * the login script, so if you need a more advanced version, have a look on
 * the github repo. there are / will be better versions, including more
