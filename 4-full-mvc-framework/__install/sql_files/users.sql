...
CREATE TABLE `users` (
 ...
 `user_has_avatar` BOOLEAN NOT NULL DEFAULT FALSE COMMENT 'user''s avatar status',
 `user_rememberme_token` VARCHAR(64) NULL COMMENT 'user''s remember-me cookie token',
 `user_failed_logins` tinyint(1) NOT NULL DEFAULT '0' COMMENT 'user''s failed login attemps',
 `user_last_failed_login` INT( 10 ) NULL COMMENT 'unix timestamp of last failed login attempt',
 `user_activation_hash` varchar(40) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'user''s email verification hash string',
 `user_password_reset_hash` char(40) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'user''s password reset code',
 `user_password_reset_timestamp` bigint(20) DEFAULT NULL COMMENT 'unix timestamp of the password reset request',
 PRIMARY KEY (`user_id`),
